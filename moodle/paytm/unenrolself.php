...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'paytm'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/paytm/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_paytm', format_string($course->fullname));
